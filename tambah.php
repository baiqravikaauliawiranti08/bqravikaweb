...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO tbl_mahasiswa (npm, nama, prodi, email, alamat) VALUES (?, ?, ?, ?, ?)";
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo "<script>alert('Gagal menyimpan data: " . addslashes(mysqli_error($koneksi)) . "');</script>";
    }
...
<body>
    ...
    <form method="POST" action="">
        <table>
            ...
            <tr>
                <td colspan="2"><input type="submit" name="submit" value="Simpan Data"></td>
            </tr>
        </table>
    </form>
